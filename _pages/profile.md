...
My research focuses on astrophysical turbulence, magnetic fields and the small-scale turbulent dynamo. I work on understanding magnetic field evolution in the collisionless plasma, like the hot intracluster medium of galaxy clusters, using hybrid kinetic simulations. To do so, I have developed a hybrid particle-in-cell code within the FLASH code called "AHKASH". I have also worked on understanding the properties of the collisional magnetohydrodynamic small-scale turbulent dynamo in the low Mach number regime.
